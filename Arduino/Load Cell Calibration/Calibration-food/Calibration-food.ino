...
void calibrate() {
  ...
  float newCalibrationValue_1 = LoadCell.getNewCalibration(known_mass); //get the new calibration value
...
void changeSavedCalFactor() {
  ...
  while (_resume == false) {
    if (Serial.available() > 0) {
      newCalibrationValue_1 = Serial.parseFloat();
      if (newCalibrationValue_1 != 0) {
        Serial.print("New calibration value is: ");
        Serial.println(newCalibrationValue_1);
        LoadCell.setCalFactor(newCalibrationValue_1);
        _resume = true;
      }
    }
  }
